...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/create-routine', icon: Calendar, label: 'Create Workout' },
    { path: '/create-exercise', icon: Dumbbell, label: 'Create Exercise' },
    {path: '/with-routine', icon: Calendar, label: 'View Workouts'},
  ];
  ...
  return (
    ...
    >
      <div className="max-w-[100%] mx-auto px-4 sm:px-6 lg:px-6">
